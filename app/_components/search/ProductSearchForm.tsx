...
import { MIN_SEARCH_VALUE, SHOP_ROUTE } from '@/app/_config/constants/variables'
import { ProductSearchFormInputType, ProductSearchSchema } from '@/app/_config/schemas/search'
